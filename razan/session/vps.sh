...
echo -e $FERRARI
echo -e $ROZ
echo "Cloning FERRARI Userbot"
echo -e $ROZ
git clone -b bro https://github.com/theFERRARI/sbb_b0
echo -e $FERRARI
echo -e $ROZ
echo "runing FERRARI now"
echo -e $ROZ
cd sbb_b0

# Rename sample_config.py to config.py
mv FERRARI.py config.py
echo "⚙️ Environment "
echo -e $ROZ
...
# database
DATABASE_URL="postgresql://postgres:$PASSWORD@localhost:5432/FERRARI"
