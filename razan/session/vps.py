...
FERRARI = "\nFERRARI USERBOT DEPLOY ON VPS"
FERRARI += "\n "
FERRARI += "\n "
FERRARI += "\n★ Channel: @FERRARI ★"
FERRARI += "\n★ Support: @FERRARI_support ★"
FERRARI += "\n "
ROZ = "\n "
print(FERRARI)
print(ROZ)
...
print(FERRARI)
print(ROZ)
print("Cloning FERRARI Userbot")
print(ROZ)
os.system("git clone -b bro https://github.com/theFERRARI/sbb_b0")
print(FERRARI)
print(ROZ)
print("runing FERRARI now")
print(ROZ)
os.chdir("sbb_b0")

# Rename sample_config.py to config.py
os.rename("FERRARI.py", "config.py")
print("⚙️ Environment ")
print(ROZ)
...
os.system("CREATE DATABASE FERRARI;")
os.system("\q")
os.system("exit")
os.system("EOF")

# database
database_url = f"postgresql://postgres:{password}@localhost:5432/FERRARI"
...
os.system(
    "screen -S FERRARI bash -c 'virtualenv venv && source venv/bin/activate && pip3 install -r requirements.txt && clear && python3 -m sbb_b'"
)
