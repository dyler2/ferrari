...
@ferrari.ar_cmd(pattern="صنع (مجموعة خارقة|مجموعة عادية|قناة) ([\s\S]*)")
async def _(event):
    type_of_group = event.pattern_match.group(1)
    group_name = event.pattern_match.group(2)
    if type_of_group == "قناة":
        descript = "تم صنع هذه القناة بواسطة سورس فيراري"
    else:
        descript = "تم صنع المجموعة باستخدام سورس فيراري"
