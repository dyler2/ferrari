...
from . import edit_delete, edit_or_reply, ferrari, mention
...
async def _(event):
    ...
    animation_chars = [
        ...
        "**Starting process with command** `python3 -m ferrari`",
        "**State changed from starting to up**",
        "__INFO:ferrari:Logged in as 557667062__",
        "__INFO:ferrari:Successfully loaded all plugins__",
        "**Build Succeeded**",
    ]
...
@ferrari.on(admin_cmd(pattern="احبك"))
async def rz(ferrari):
    roz = random.choice(love)
    return await edit_or_reply(ferrari, roz)
