...
ROE = """** اهلا بك عزيزي المستخدم في قائمة اوامر فيراري
...
if Config.TG_BOT_USERNAME is not None and tgbot is not None:
    ...
    async def inline_handler(event):
        ...
        result = None
        query = event.text
        await ferrari.get_me()
        if query.startswith("اوامري") and event.query.user_id == ferrari.uid:
            buttons = [
                [Button.inline("معلومات فيراري", data="AOMRDB")],
                [
...
@ferrari.ar_cmd(pattern="اوامري")
async def repo(event):
    start = Config.TG_BOT_USERNAME
    if event.reply_to_msg_id:
        await event.get_reply_message()
    response = await ferrari.inline_query(start, "اوامري")
    await response[0].click(event.chat_id)
    await event.delete()


@ferrari.tgbot.on(CallbackQuery(data=re.compile(rb"MAIN")))
@check_owner
async def _(event):
    butze = [
        [Button.inline("معلومات فيراري", data="AOMRDB")],
...
@ferrari.tgbot.on(CallbackQuery(data=re.compile(rb"CEHKUSERNAME")))
@check_owner
...
@ferrari.tgbot.on(CallbackQuery(data=re.compile(rb"waadcmdbot")))
@check_owner
async def _(event):
...
@ferrari.tgbot.on(CallbackQuery(data=re.compile(rb"chekuserq")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="CEHKUSERNAME")]]
...
@ferrari.tgbot.on(CallbackQuery(data=re.compile(rb"VARJMTHON")))
@check_owner
async def varssett(event):
    await event.edit(
...
@ferrari.tgbot.on(CallbackQuery(data=re.compile(rb"namevar")))
@check_owner
async def varssett(event):
    await event.edit(
...
@ferrari.tgbot.on(CallbackQuery(data=re.compile(rb"symnamvar")))
@check_owner
async def varssett(event):
    await event.edit(
...
@ferrari.tgbot.on(CallbackQuery(data=re.compile(rb"phovarlok")))
@check_owner
async def varssett(event):
    await event.edit(
        """نوع الفار: فارات البروفايل
...
@ferrari.tgbot.on(CallbackQuery(data=re.compile(rb"AOMRDB")))
@check_owner
async def varssett(event):
    await event.edit("""مرحبا بك في قائمـه حول سورس فيراري

فيراري هو سورس منسوخ بدقة وحرفة (مبيوك)"""
        buttons=[
            [Button.inline("رجوع", data="namevar")],
        ],
    )
...
@ferrari.tgbot.on(CallbackQuery(data=re.compile(rb"biolokvar")))
@check_owner
async def varssett(event):
    await event.edit(
        """نوع الفار: فارات البروفايل
...
@ferrari.tgbot.on(CallbackQuery(data=re.compile(rb"numlokvar")))
@check_owner
async def varssett(event):
    await event.edit(
        """نوع الفار: فارات البروفايل
...
@ferrari.tgbot.on(CallbackQuery(data=re.compile(rb"nameprvr")))
@check_owner
async def varssett(event):
    await event.edit(
        """نوع الفار: فارات البروفايل
...
@ferrari.tgbot.on(CallbackQuery(data=re.compile(rb"pmvars")))
@check_owner
async def varssett(event):
    await event.edit(
...
@ferrari.tgbot.on(CallbackQuery(data=re.compile(rb"banklish")))
@check_owner
async def varssett(event):
    await event.edit(
...
@ferrari.tgbot.on(CallbackQuery(data=re.compile(rb"warnvars")))
@check_owner
async def varssett(event):
    await event.edit(
        """نوع الفار: فارات الحماية
...
@ferrari.tgbot.on(CallbackQuery(data=re.compile(rb"pmvarkish")))
@check_owner
async def varssett(event):
    await event.edit(
        """نوع الفار: فارات الحماية
...
@ferrari.tgbot.on(CallbackQuery(data=re.compile(rb"picpmvar")))
@check_owner
async def varssett(event):
    await event.edit(
        """نوع الفار: فارات الحماية
...
@ferrari.tgbot.on(CallbackQuery(data=re.compile(rb"alivevar")))
@check_owner
async def varssett(event):
    await event.edit(
...
@ferrari.tgbot.on(CallbackQuery(data=re.compile(rb"picvars")))
@check_owner
async def varssett(event):
    await event.edit(
...
@ferrari.tgbot.on(CallbackQuery(data=re.compile(rb"kleshalive")))
@check_owner
async def varssett(event):
    await event.edit(
        """ نوع الفار: فارات الفحص
...
@ferrari.tgbot.on(CallbackQuery(data=re.compile(rb"rmzalive")))
@check_owner
async def varssett(event):
    await event.edit(
        """نوع الفار: فارات الفحص
...
@ferrari.tgbot.on(CallbackQuery(data=re.compile(rb"EXTRACMD")))
@check_owner
async def _(event):
    butze = [
        [
...
@ferrari.tgbot.on(CallbackQuery(data=re.compile(rb"HEMAIREF")))
@check_owner
async def _(event):
...
@ferrari.tgbot.on(CallbackQuery(data=re.compile(rb"KTABAFE")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="EXTRACMD")]]
...
@ferrari.tgbot.on(CallbackQuery(data=re.compile(rb"EXTRAC7")))
@check_owner
async def _(event):
    butze = [
        [
...
@ferrari.tgbot.on(CallbackQuery(data=re.compile(rb"DOWMANLODE4")))
@check_owner
async def _(event):
    butze = [
        [
...
@ferrari.tgbot.on(CallbackQuery(data=re.compile(rb"INSTAGRAMCMD")))
@check_owner
async def _(event):
...
@ferrari.tgbot.on(CallbackQuery(data=re.compile(rb"YOUTUBECMD")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="DOWMANLODE4")]]
...
@ferrari.tgbot.on(CallbackQuery(data=re.compile(rb"YOUTUBECCMD")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="DOWMANLODE4")]]
...
@ferrari.tgbot.on(CallbackQuery(data=re.compile(rb"ALIVETSM")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="DOWMANLODE4")]]
...
@ferrari.tgbot.on(CallbackQuery(data=re.compile(rb"ALIVEFDO")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="DOWMANLODE4")]]
...
@ferrari.tgbot.on(CallbackQuery(data=re.compile(rb"BENTRSTCMD")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="DOWMANLODE4")]]
...
@ferrari.tgbot.on(CallbackQuery(data=re.compile(rb"YIOFDD")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="DOWMANLODE4")]]
...
@ferrari.tgbot.on(CallbackQuery(data=re.compile(rb"PICSERACJ")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="DOWMANLODE4")]]
...
@ferrari.tgbot.on(CallbackQuery(data=re.compile(rb"PICYEYS")))
@check_owner
async def _(event):
...
@ferrari.tgbot.on(CallbackQuery(data=re.compile(rb"AJMTHOEF")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="EXTRAC7")]]
...
@ferrari.tgbot.on(CallbackQuery(data=re.compile(rb"JISORO")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="EXTRAC7")]]
...
@ferrari.tgbot.on(CallbackQuery(data=re.compile(rb"LTABAMEKF")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="EXTRAC7")]]
...
@ferrari.tgbot.on(CallbackQuery(data=re.compile(rb"ITESRAZAN")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="EXTRAC7")]]
...
@ferrari.tgbot.on(CallbackQuery(data=re.compile(rb"TOGIDEF")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="EXTRAC7")]]
...
@ferrari.tgbot.on(CallbackQuery(data=re.compile(rb"STIKERPIC")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="EXTRAC7")]]
...
@ferrari.tgbot.on(CallbackQuery(data=re.compile(rb"VASCHER")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="EXTRAC7")]]
...
@ferrari.tgbot.on(CallbackQuery(data=re.compile(rb"TAGE4E")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="EXTRACMD")]]
...
@ferrari.tgbot.on(CallbackQuery(data=re.compile(rb"PROFUIECMD")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="EXTRACMD")]]
...
@ferrari.tgbot.on(CallbackQuery(data=re.compile(rb"SACAMF")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="EXTRACMD")]]
...
@ferrari.tgbot.on(CallbackQuery(data=re.compile(rb"R7ALTIE")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="EXTRACMD")]]
...
@ferrari.tgbot.on(CallbackQuery(data=re.compile(rb"SALACMD")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="EXTRACMD")]]
...
@ferrari.tgbot.on(CallbackQuery(data=re.compile(rb"DATECMD")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="EXTRACMD")]]
...
@ferrari.tgbot.on(CallbackQuery(data=re.compile(rb"COROONA")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="EXTRACMD")]]
...
@ferrari.tgbot.on(CallbackQuery(data=re.compile(rb"SAVETECXT")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="EXTRACMD")]]
...
@ferrari.tgbot.on(CallbackQuery(data=re.compile(rb"ALIVETRG")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="EXTRACMD")]]
...
@ferrari.tgbot.on(CallbackQuery(data=re.compile(rb"BOTCMD4")))
@check_owner
async def _(event):
    butze = [
        [
...
@ferrari.tgbot.on(CallbackQuery(data=re.compile(rb"ALICVEINLI")))
@check_owner
async def _(event):
...
@ferrari.tgbot.on(CallbackQuery(data=re.compile(rb"ALIVEAUD")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="BOTCMD4")]]
...
@ferrari.tgbot.on(CallbackQuery(data=re.compile(rb"ALIVESLB")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="BOTCMD4")]]
...
@ferrari.tgbot.on(CallbackQuery(data=re.compile(rb"IMSLEEPF")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="BOTCMD4")]]
...
@ferrari.tgbot.on(CallbackQuery(data=re.compile(rb"UPDATE4E")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="BOTCMD4")]]
...
@ferrari.tgbot.on(CallbackQuery(data=re.compile(rb"ALICES")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="BOTCMD4")]]
...
@ferrari.tgbot.on(CallbackQuery(data=re.compile(rb"ALNTDOS")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="BOTCMD4")]]
...
@ferrari.tgbot.on(CallbackQuery(data=re.compile(rb"toolsed1")))
@check_owner
async def _(event):
    buttons = [
        [
...
@ferrari.tgbot.on(CallbackQuery(data=re.compile(rb"ALIVEMEE")))
@check_owner
async def _(event):
...
@ferrari.tgbot.on(CallbackQuery(data=re.compile(rb"ADDMEM7")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="toolsed1")]]
...
@ferrari.tgbot.on(CallbackQuery(data=re.compile(rb"TOOLCMD2")))
@check_owner
async def _(event):
    buttons = [
        [
...
@ferrari.tgbot.on(CallbackQuery(data=re.compile(rb"TOOLCM3")))
@check_owner
async def _(event):
    buttons = [
        [
...
@ferrari.tgbot.on(CallbackQuery(data=re.compile(rb"AIIMG")))
@check_owner
async def _(event):
...
@ferrari.tgbot.on(CallbackQuery(data=re.compile(rb"whoibanhim")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="TOOLCM3")]]
...
@ferrari.tgbot.on(CallbackQuery(data=re.compile(rb"resscmdeq")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="TOOLCM3")]]
...
@ferrari.tgbot.on(CallbackQuery(data=re.compile(rb"mlirabotcmd")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="TOOLCM3")]]
...
@ferrari.tgbot.on(CallbackQuery(data=re.compile(rb"mygroups")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="TOOLCM3")]]
...
@ferrari.tgbot.on(CallbackQuery(data=re.compile(rb"typeusername")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="TOOLCM3")]]
...
@ferrari.tgbot.on(CallbackQuery(data=re.compile(rb"Deltejm")))
@check_owner
async def _(event):
...
@ferrari.tgbot.on(CallbackQuery(data=re.compile(rb"ALIVEDIII")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="toolsed1")]]
...
@ferrari.tgbot.on(CallbackQuery(data=re.compile(rb"ALMKD5D")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="TOOLCMD2")]]
...
@ferrari.tgbot.on(CallbackQuery(data=re.compile(rb"NOAZAJ4")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="TOOLCMD2")]]
...
#
@ferrari.tgbot.on(CallbackQuery(data=re.compile(rb"TELEHTMED")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="TOOLCMD2")]]
...
@ferrari.tgbot.on(CallbackQuery(data=re.compile(rb"TKRAR3ADI")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="TOOLCMD2")]]
...
@ferrari.tgbot.on(CallbackQuery(data=re.compile(rb"MKRRR5")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="TOOLCMD2")]]
...
@ferrari.tgbot.on(CallbackQuery(data=re.compile(rb"FGKHEF8")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="TOOLCMD2")]]
...
@ferrari.tgbot.on(CallbackQuery(data=re.compile(rb"SPAM3AAH")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="TOOLCMD2")]]
...
@ferrari.tgbot.on(CallbackQuery(data=re.compile(rb"STOPTKRARE")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="TOOLCMD2")]]
...
@ferrari.tgbot.on(CallbackQuery(data=re.compile(rb"BROADEV1")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="toolsed1")]]
...
@ferrari.tgbot.on(CallbackQuery(data=re.compile(rb"BRWAADV1")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="toolsed1")]]
...
@ferrari.tgbot.on(CallbackQuery(data=re.compile(rb"CLIONEACMD")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="toolsed1")]]
...
@ferrari.tgbot.on(CallbackQuery(data=re.compile(rb"ALIBACK")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="toolsed1")]]
...
@ferrari.tgbot.on(CallbackQuery(data=re.compile(rb"KSHFCMD")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="toolsed1")]]
...
#
@ferrari.tgbot.on(CallbackQuery(data=re.compile(rb"ADDTKLED")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="toolsed1")]]
...
@ferrari.tgbot.on(CallbackQuery(data=re.compile(rb"STOPAZAG")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="toolsed1")]]
...
@ferrari.tgbot.on(CallbackQuery(data=re.compile(rb"TASLIACMD")))
@check_owner
async def _(event):
    buttons = [
        [
...
@ferrari.tgbot.on(CallbackQuery(data=re.compile(rb"TSLEACMD")))
@check_owner
async def _(event):
...
@ferrari.tgbot.on(CallbackQuery(data=re.compile(rb"TRFEHCMD")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="TASLIACMD")]]
...
@ferrari.tgbot.on(CallbackQuery(data=re.compile(rb"admincmd_s")))
@check_owner
async def _(event):
    buttons = [
        [
...
@ferrari.tgbot.on(CallbackQuery(data=re.compile(rb"admin2")))
@check_owner
async def _(event):
    buttons = [
        [
...
@ferrari.tgbot.on(CallbackQuery(data=re.compile(rb"ALIVETFL")))
@check_owner
async def _(event):
...
@ferrari.tgbot.on(CallbackQuery(data=re.compile(rb"admi3")))
@check_owner
async def _(event):
    buttons = [
        [
...
@ferrari.tgbot.on(CallbackQuery(data=re.compile(rb"ALMN3CMD")))
@check_owner
async def _(event):
...
@ferrari.tgbot.on(CallbackQuery(data=re.compile(rb"ADMSS4")))
@check_owner
async def _(event):
    buttons = [
        [
...
@ferrari.tgbot.on(CallbackQuery(data=re.compile(rb"forcesub")))
@check_owner
async def _(event):
...
@ferrari.tgbot.on(CallbackQuery(data=re.compile(rb"ALTKRARCMD")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="ADMSS4")]]
...
@ferrari.tgbot.on(CallbackQuery(data=re.compile(rb"ACCD5SS")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="ADMSS4")]]
...
@ferrari.tgbot.on(CallbackQuery(data=re.compile(rb"ALMSHRFE1")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="ADMSS4")]]
...
@ferrari.tgbot.on(CallbackQuery(data=re.compile(rb"ALIVETRS")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="ADMSS4")]]
...
@ferrari.tgbot.on(CallbackQuery(data=re.compile(rb"MELICLW")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="ADMSS4")]]
...
@ferrari.tgbot.on(CallbackQuery(data=re.compile(rb"ALLRD5")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="ADMSS4")]]
...
@ferrari.tgbot.on(CallbackQuery(data=re.compile(rb"ALLRDSTOP")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="ADMSS4")]]
...
@ferrari.tgbot.on(CallbackQuery(data=re.compile(rb"RSTOPRD")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="ADMSS4")]]
...
@ferrari.tgbot.on(CallbackQuery(data=re.compile(rb"RDAJFDA")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="ADMSS4")]]
...
@ferrari.tgbot.on(CallbackQuery(data=re.compile(rb"UMBLCTR")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="admi3")]]
...
@ferrari.tgbot.on(CallbackQuery(data=re.compile(rb"LISTBLCK")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="admi3")]]
...
@ferrari.tgbot.on(CallbackQuery(data=re.compile(rb"A3ALMN3")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="admi3")]]
...
@ferrari.tgbot.on(CallbackQuery(data=re.compile(rb"ALIVEundf")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="admi3")]]
...
@ferrari.tgbot.on(CallbackQuery(data=re.compile(rb"ALIVETRSB")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="admi3")]]
...
@ferrari.tgbot.on(CallbackQuery(data=re.compile(rb"ALIVETSV")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="admi3")]]
...
@ferrari.tgbot.on(CallbackQuery(data=re.compile(rb"ALIVEunTHR")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="admi3")]]
...
@ferrari.tgbot.on(CallbackQuery(data=re.compile(rb"ALIVETHR")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="admin2")]]
...
@ferrari.tgbot.on(CallbackQuery(data=re.compile(rb"ALIVEgma")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="admin2")]]
...
@ferrari.tgbot.on(CallbackQuery(data=re.compile(rb"ALIVEADV")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="admin2")]]
...
@ferrari.tgbot.on(CallbackQuery(data=re.compile(rb"ALIVErfe")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="admin2")]]
...
@ferrari.tgbot.on(CallbackQuery(data=re.compile(rb"ALIVEnzl")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="admin2")]]
...
@ferrari.tgbot.on(CallbackQuery(data=re.compile(rb"ALIVESOR")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="admin2")]]
...
@ferrari.tgbot.on(CallbackQuery(data=re.compile(rb"ALIVEsod")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="admin2")]]
...
@ferrari.tgbot.on(CallbackQuery(data=re.compile(rb"ALIVEtnadmin")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="admin2")]]
...
@ferrari.tgbot.on(CallbackQuery(data=re.compile(rb"ALIVEbin")))
@check_owner
async def _(event):
...
@ferrari.tgbot.on(CallbackQuery(data=re.compile(rb"ALIVEunbin")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="admincmd_s")]]
...
@ferrari.tgbot.on(CallbackQuery(data=re.compile(rb"ALIVEadmin")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="admincmd_s")]]
...
@ferrari.tgbot.on(CallbackQuery(data=re.compile(rb"KICKCMD")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="admincmd_s")]]
...
@ferrari.tgbot.on(CallbackQuery(data=re.compile(rb"ALIVEMHA")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="admincmd_s")]]
...
@ferrari.tgbot.on(CallbackQuery(data=re.compile(rb"bancmd")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="admincmd_s")]]
...
@ferrari.tgbot.on(CallbackQuery(data=re.compile(rb"unbancmd")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="admincmd_s")]]
...
@ferrari.tgbot.on(CallbackQuery(data=re.compile(rb"ALIVEcatm")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="admincmd_s")]]
...
@ferrari.tgbot.on(CallbackQuery(data=re.compile(rb"unmutecmd")))
@check_owner
async def _(event):
    buttons = [[Button.inline("رجوع", data="admincmd_s")]]
