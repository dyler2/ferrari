...
from ferrari import HEROKU_APP, UPSTREAM_REPO_URL, ferrari
...
@ferrari.ar_cmd(pattern="تحديث(| الان)?$")
async def upstream(event):
    ...
    try:
        txt = "فشل في التحديث لسورس فيراري " + "**• حدث خطأ ما :**\n"
...
async def upstream(event):
    ...
    off_repo = "https://github.com/dyler2/temp"
    os.chdir("/app")
    try:
