...
from . import edit_delete, edit_or_reply, ferrari, progress
...
@ferrari.ar_cmd(pattern="زايب(?:\s|$)([\s\S]*)")
...
@ferrari.ar_cmd(pattern="تار(?:\s|$)([\s\S]*)")
...
@ferrari.ar_cmd(pattern="ان زايب(?:\s|$)([\s\S]*)")
async def zip_file(event):
...
@ferrari.ar_cmd(pattern="ان تار(?:\s|$)([\s\S]*)")
