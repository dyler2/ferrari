...
@ferrari.ar_cmd(pattern="وضع بايو ([\s\S]*)")
async def _(event):
...
@ferrari.ar_cmd(pattern="وضع اسم ([\s\S]*)")
async def _(event):
...
@ferrari.ar_cmd(pattern="وضع صورة$")
async def _(event):
...
@ferrari.ar_cmd(pattern="وضع يوزر ([\s\S]*)")
...
@ferrari.ar_cmd(pattern="ازالة الصورة ?([\s\S]*)")
...
@ferrari.ar_cmd(pattern="معرفاتي$")
async def _(event):
