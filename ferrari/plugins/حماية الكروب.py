...
@ferrari.ar_cmd(pattern="قفل ?(.*)", groups_only=True, require_admin=True)
async def _(event):
...
@ferrari.ar_cmd(pattern="فتح ?(.*)", groups_only=True, require_admin=True)
async def _(event):
...
@ferrari.ar_cmd(pattern="الاعدادات$", groups_only=True)
async def _(event):
    res = ""
...
@ferrari.ar_cmd(incoming=True, forword=None)
...
@ferrari.ar_cmd(pattern=f"البوتات ?(.*)")
