...
@ferrari.ar_cmd(incoming=True, func=lambda e: e.mentioned, edited=False, forword=None)
...
async def tl(e):
    ...
    await ferrari.send_file(Config.PM_LOGGER_GROUP_ID, result, caption=caption)
