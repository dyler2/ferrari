...
from ferrari import StartTime, ferrari, jmthonversion
...
async def amireallyalive(event):
    ...
    ALIVE_TEXT = gvarstatus("ALIVE_TEXT") or "**سورس فيراري يعمل بنجاح**"
...
ROZ_T = (
    f"**⌯︙بوت فيراري يعمل بنجاح 🤍،**\n"
    f"**   - اصدار التليثون :** `1.23.0\n`"
    f"**   - اصدار فيراري :** `4.0.0`\n"
...
if Config.TG_BOT_USERNAME is not None and tgbot is not None:
    ...
    async def inline_handler(event):
        ...
        if query.startswith("السورس") and event.query.user_id == ferrari.uid:
            buttons = [
                [
                    Button.url("قنـاة السـورس ⚙️", "https://t.me/ferrarisrc"),
