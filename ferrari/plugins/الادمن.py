...
@ferrari.ar_cmd(pattern="كتم(?:\s|$)([\s\S]*)")
...
@ferrari.ar_cmd(pattern="الغاء كتم(?:\s|$)([\s\S]*)")
...
@ferrari.ar_cmd(pattern="الغاء تثبيت( الكل|$)")
