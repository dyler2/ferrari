...
@ferrari.ar_cmd(pattern="كرر ([\s\S]*)")
...
@ferrari.ar_cmd(pattern=f"{TKRAR} (.*)")
async def spammer(event):
    reply = await event.get_reply_message()
...
@ferrari.ar_cmd(pattern="تعبير مكرر$")
...
@ferrari.ar_cmd(pattern="ايقاف التكرار ?(.*)")
