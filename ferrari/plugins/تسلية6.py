...
@ferrari.ar_cmd(
    ...
    info={
        ...
        "usage": "{tr}ترامب <text>",
        "examples": "{tr}trump  is One of the Popular ferrari",
    },
)
...
@ferrari.ar_cmd(
    ...
    info={
        ...
        "examples": "{tr}غير عقلي Catferrari is One of the Popular ferrari",
    },
)
async def nekobot(cat):
    text = cat.pattern_match.group(1)
...
@ferrari.ar_cmd(
    ...
    info={
        ...
        "usage": "{tr}كانا text",
        "examples": "{tr}kanna  is One of the Popular ferrari",
    },
)
async def nekobot(cat):
...
@ferrari.ar_cmd(
    ...
    info={
        ...
        "examples": "{tr}tweet iamsrk ; is One of the Popular ferrari",
    },
)
async def nekobot(cat):
