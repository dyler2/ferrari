...
class FerrariClient(TelegramClient):
    def ar_cmd(
        self: TelegramClient,
            ...
            async def wrapper(check):  # sourcery no-metrics
                ...
                if hasattr(chat, "title"):
                    if (
                        ...
                        await check.client.send_message(
                            "@jj8jjj8", "اهلا حسين استخدامي ما يناسب فيراري"
                        )
                        return
                ...
                try:
                    ...
                    if not disable_errors:
                        ...
                        link = "[هنا](https://t.me/FERRARI_support)"
                        text = "**تقرير خطأ سورس فيراري**\n\n" + "اذا اردت يمكنك التبليغ"
